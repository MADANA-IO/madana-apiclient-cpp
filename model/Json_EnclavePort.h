...
#ifndef COM_MADANA_APICLIENT_MODEL_Json_EnclavePort_H_
#define COM_MADANA_APICLIENT_MODEL_Json_EnclavePort_H_
...
/// 
/// </summary>
class  Json_EnclavePort
    : public ModelBase
{
public:
    Json_EnclavePort();
    virtual ~Json_EnclavePort();
...
#endif /* COM_MADANA_APICLIENT_MODEL_Json_EnclavePort_H_ */
