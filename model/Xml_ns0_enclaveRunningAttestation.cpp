...
std::shared_ptr<Xml_ns0_enclaveProcess> Xml_ns0_enclaveRunningAttestation::getEnclaveProcess() const
{
    return m_EnclaveProcess;
}

void Xml_ns0_enclaveRunningAttestation::setEnclaveProcess(const std::shared_ptr<Xml_ns0_enclaveProcess>& value)
{
    m_EnclaveProcess = value;
    m_EnclaveProcessIsSet = true;
}

bool Xml_ns0_enclaveRunningAttestation::enclaveProcessIsSet() const
{
    return m_EnclaveProcessIsSet;
}

void Xml_ns0_enclaveRunningAttestation::unsetEnclaveProcess()
{
    m_EnclaveProcessIsSet = false;
}
std::shared_ptr<Xml_ns0_nodeInfo> Xml_ns0_enclaveRunningAttestation::getNodeInfo() const
{
    return m_NodeInfo;
}

void Xml_ns0_enclaveRunningAttestation::setNodeInfo(const std::shared_ptr<Xml_ns0_nodeInfo>& value)
{
    m_NodeInfo = value;
    m_NodeInfoIsSet = true;
}

bool Xml_ns0_enclaveRunningAttestation::nodeInfoIsSet() const
{
    return m_NodeInfoIsSet;
}

void Xml_ns0_enclaveRunningAttestation::unsetNodeInfo()
{
    m_NodeInfoIsSet = false;
}
}
