...
Json_Analysis_allOf::Json_Analysis_allOf()
{
...
void Json_Analysis_allOf::validate()
{
    // TODO: implement validation
}

web::json::value Json_Analysis_allOf::toJson() const
{
...
bool Json_Analysis_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Json_Analysis_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Json_Analysis_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t Json_Analysis_allOf::getCreated() const
{
    return m_Created;
}

void Json_Analysis_allOf::setCreated(const utility::string_t& value)
{
    m_Created = value;
    m_CreatedIsSet = true;
}

bool Json_Analysis_allOf::createdIsSet() const
{
    return m_CreatedIsSet;
}

void Json_Analysis_allOf::unsetCreated()
{
    m_CreatedIsSet = false;
}
utility::string_t Json_Analysis_allOf::getUuid() const
{
    return m_Uuid;
}

void Json_Analysis_allOf::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool Json_Analysis_allOf::uuidIsSet() const
{
    return m_UuidIsSet;
}

void Json_Analysis_allOf::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t Json_Analysis_allOf::getStatus() const
{
    return m_Status;
}

void Json_Analysis_allOf::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Json_Analysis_allOf::statusIsSet() const
{
    return m_StatusIsSet;
}

void Json_Analysis_allOf::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t Json_Analysis_allOf::getAgent() const
{
    return m_Agent;
}

void Json_Analysis_allOf::setAgent(const utility::string_t& value)
{
    m_Agent = value;
    m_AgentIsSet = true;
}

bool Json_Analysis_allOf::agentIsSet() const
{
    return m_AgentIsSet;
}

void Json_Analysis_allOf::unsetAgent()
{
    m_AgentIsSet = false;
}
std::vector<std::shared_ptr<Json_DatasetInfo>>& Json_Analysis_allOf::getDatasets()
{
    return m_Datasets;
}

void Json_Analysis_allOf::setDatasets(const std::vector<std::shared_ptr<Json_DatasetInfo>>& value)
{
    m_Datasets = value;
    m_DatasetsIsSet = true;
}

bool Json_Analysis_allOf::datasetsIsSet() const
{
    return m_DatasetsIsSet;
}

void Json_Analysis_allOf::unsetDatasets()
{
    m_DatasetsIsSet = false;
}
std::vector<utility::string_t>& Json_Analysis_allOf::getParticipants()
{
    return m_Participants;
}

void Json_Analysis_allOf::setParticipants(const std::vector<utility::string_t>& value)
{
    m_Participants = value;
    m_ParticipantsIsSet = true;
}

bool Json_Analysis_allOf::participantsIsSet() const
{
    return m_ParticipantsIsSet;
}

void Json_Analysis_allOf::unsetParticipants()
{
    m_ParticipantsIsSet = false;
}
utility::string_t Json_Analysis_allOf::getViews() const
{
    return m_Views;
}

void Json_Analysis_allOf::setViews(const utility::string_t& value)
{
    m_Views = value;
    m_ViewsIsSet = true;
}

bool Json_Analysis_allOf::viewsIsSet() const
{
    return m_ViewsIsSet;
}

void Json_Analysis_allOf::unsetViews()
{
    m_ViewsIsSet = false;
}
std::vector<std::shared_ptr<Json_AnalysisRequestAction>>& Json_Analysis_allOf::getActions()
{
    return m_Actions;
}

void Json_Analysis_allOf::setActions(const std::vector<std::shared_ptr<Json_AnalysisRequestAction>>& value)
{
    m_Actions = value;
    m_ActionsIsSet = true;
}

bool Json_Analysis_allOf::actionsIsSet() const
{
    return m_ActionsIsSet;
}

void Json_Analysis_allOf::unsetActions()
{
    m_ActionsIsSet = false;
}
utility::string_t Json_Analysis_allOf::getCreator() const
{
    return m_Creator;
}

void Json_Analysis_allOf::setCreator(const utility::string_t& value)
{
    m_Creator = value;
    m_CreatorIsSet = true;
}

bool Json_Analysis_allOf::creatorIsSet() const
{
    return m_CreatorIsSet;
}

void Json_Analysis_allOf::unsetCreator()
{
    m_CreatorIsSet = false;
}
utility::string_t Json_Analysis_allOf::getDatasetCount() const
{
    return m_DatasetCount;
}

void Json_Analysis_allOf::setDatasetCount(const utility::string_t& value)
{
    m_DatasetCount = value;
    m_DatasetCountIsSet = true;
}

bool Json_Analysis_allOf::datasetCountIsSet() const
{
    return m_DatasetCountIsSet;
}

void Json_Analysis_allOf::unsetDatasetCount()
{
    m_DatasetCountIsSet = false;
}
}
