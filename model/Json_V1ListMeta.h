...
#ifndef COM_MADANA_APICLIENT_MODEL_Json_V1ListMeta_H_
#define COM_MADANA_APICLIENT_MODEL_Json_V1ListMeta_H_
...
/// 
/// </summary>
class  Json_V1ListMeta
    : public ModelBase
{
public:
    Json_V1ListMeta();
    virtual ~Json_V1ListMeta();
    ...
    /// 
    /// </summary>
    utility::string_t getRContinue() const;
    bool rContinueIsSet() const;
    void unsetr_continue();

    void setRContinue(const utility::string_t& value);

    /// <summary>
    /// 
    /// </summary>
    double getRemainingItemCount() const;
    bool remainingItemCountIsSet() const;
    void unsetRemainingItemCount();

    void setRemainingItemCount(double value);
...
protected:
    ...
    utility::string_t m_r_continue;
    bool m_r_continueIsSet;
    double m_RemainingItemCount;
...
#endif /* COM_MADANA_APICLIENT_MODEL_Json_V1ListMeta_H_ */
