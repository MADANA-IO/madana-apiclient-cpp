...
#ifndef COM_MADANA_APICLIENT_MODEL_Xml_ns0_nodeInfo_H_
#define COM_MADANA_APICLIENT_MODEL_Xml_ns0_nodeInfo_H_
...
/// 
/// </summary>
class  Xml_ns0_nodeInfo
    : public ModelBase
{
public:
    Xml_ns0_nodeInfo();
    virtual ~Xml_ns0_nodeInfo();
    ...
    /// 
    /// </summary>
    std::shared_ptr<Xml_ns0_SGXInfo> getSgxInfo() const;
    bool sgxInfoIsSet() const;
    void unsetSgxInfo();

    void setSgxInfo(const std::shared_ptr<Xml_ns0_SGXInfo>& value);
...
protected:
    ...
    std::shared_ptr<Xml_ns0_SGXInfo> m_SgxInfo;
    bool m_SgxInfoIsSet;
...
#endif /* COM_MADANA_APICLIENT_MODEL_Xml_ns0_nodeInfo_H_ */
