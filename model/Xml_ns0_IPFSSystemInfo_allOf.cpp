...
#include "Xml_ns0_IPFSSystemInfo_allOf.h"
...
Xml_ns0_IPFSSystemInfo_allOf::Xml_ns0_IPFSSystemInfo_allOf()
{
...
void Xml_ns0_IPFSSystemInfo_allOf::validate()
{
    // TODO: implement validation
}

web::json::value Xml_ns0_IPFSSystemInfo_allOf::toJson() const
{
...
bool Xml_ns0_IPFSSystemInfo_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Xml_ns0_IPFSSystemInfo_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Xml_ns0_IPFSSystemInfo_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t Xml_ns0_IPFSSystemInfo_allOf::getAgentVersion() const
{
    return m_AgentVersion;
}

void Xml_ns0_IPFSSystemInfo_allOf::setAgentVersion(const utility::string_t& value)
{
    m_AgentVersion = value;
    m_AgentVersionIsSet = true;
}

bool Xml_ns0_IPFSSystemInfo_allOf::agentVersionIsSet() const
{
    return m_AgentVersionIsSet;
}

void Xml_ns0_IPFSSystemInfo_allOf::unsetAgentVersion()
{
    m_AgentVersionIsSet = false;
}
utility::string_t Xml_ns0_IPFSSystemInfo_allOf::getId() const
{
    return m_Id;
}

void Xml_ns0_IPFSSystemInfo_allOf::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Xml_ns0_IPFSSystemInfo_allOf::idIsSet() const
{
    return m_IdIsSet;
}

void Xml_ns0_IPFSSystemInfo_allOf::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Xml_ns0_IPFSSystemInfo_allOf::getProtocolVersion() const
{
    return m_ProtocolVersion;
}

void Xml_ns0_IPFSSystemInfo_allOf::setProtocolVersion(const utility::string_t& value)
{
    m_ProtocolVersion = value;
    m_ProtocolVersionIsSet = true;
}

bool Xml_ns0_IPFSSystemInfo_allOf::protocolVersionIsSet() const
{
    return m_ProtocolVersionIsSet;
}

void Xml_ns0_IPFSSystemInfo_allOf::unsetProtocolVersion()
{
    m_ProtocolVersionIsSet = false;
}
utility::string_t Xml_ns0_IPFSSystemInfo_allOf::getPublicKey() const
{
    return m_PublicKey;
}

void Xml_ns0_IPFSSystemInfo_allOf::setPublicKey(const utility::string_t& value)
{
    m_PublicKey = value;
    m_PublicKeyIsSet = true;
}

bool Xml_ns0_IPFSSystemInfo_allOf::publicKeyIsSet() const
{
    return m_PublicKeyIsSet;
}

void Xml_ns0_IPFSSystemInfo_allOf::unsetPublicKey()
{
    m_PublicKeyIsSet = false;
}
utility::string_t Xml_ns0_IPFSSystemInfo_allOf::getSwarmConnection() const
{
    return m_SwarmConnection;
}

void Xml_ns0_IPFSSystemInfo_allOf::setSwarmConnection(const utility::string_t& value)
{
    m_SwarmConnection = value;
    m_SwarmConnectionIsSet = true;
}

bool Xml_ns0_IPFSSystemInfo_allOf::swarmConnectionIsSet() const
{
    return m_SwarmConnectionIsSet;
}

void Xml_ns0_IPFSSystemInfo_allOf::unsetSwarmConnection()
{
    m_SwarmConnectionIsSet = false;
}
}
