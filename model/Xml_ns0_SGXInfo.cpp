...
utility::string_t Xml_ns0_SGXInfo::getStatus() const
{
    return m_Status;
}

void Xml_ns0_SGXInfo::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Xml_ns0_SGXInfo::statusIsSet() const
{
    return m_StatusIsSet;
}

void Xml_ns0_SGXInfo::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t Xml_ns0_SGXInfo::getVersion() const
{
    return m_Version;
}

void Xml_ns0_SGXInfo::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool Xml_ns0_SGXInfo::versionIsSet() const
{
    return m_VersionIsSet;
}

void Xml_ns0_SGXInfo::unsetVersion()
{
    m_VersionIsSet = false;
}
}
