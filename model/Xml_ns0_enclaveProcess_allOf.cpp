...
utility::string_t Xml_ns0_enclaveProcess_allOf::getInternalWireguardServer() const
{
    return m_InternalWireguardServer;
}

void Xml_ns0_enclaveProcess_allOf::setInternalWireguardServer(const utility::string_t& value)
{
    m_InternalWireguardServer = value;
    m_InternalWireguardServerIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::internalWireguardServerIsSet() const
{
    return m_InternalWireguardServerIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetInternalWireguardServer()
{
    m_InternalWireguardServerIsSet = false;
}
std::shared_ptr<Xml_ns0_kubernetesEnclave> Xml_ns0_enclaveProcess_allOf::getKubernetesEnclave() const
{
    return m_KubernetesEnclave;
}

void Xml_ns0_enclaveProcess_allOf::setKubernetesEnclave(const std::shared_ptr<Xml_ns0_kubernetesEnclave>& value)
{
    m_KubernetesEnclave = value;
    m_KubernetesEnclaveIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::kubernetesEnclaveIsSet() const
{
    return m_KubernetesEnclaveIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetKubernetesEnclave()
{
    m_KubernetesEnclaveIsSet = false;
}
std::shared_ptr<Object> Xml_ns0_enclaveProcess_allOf::getPortMapping() const
{
    return m_PortMapping;
}

void Xml_ns0_enclaveProcess_allOf::setPortMapping(const std::shared_ptr<Object>& value)
{
    m_PortMapping = value;
    m_PortMappingIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::portMappingIsSet() const
{
    return m_PortMappingIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetPortMapping()
{
    m_PortMappingIsSet = false;
}
std::vector<std::shared_ptr<Xml_ns0_enclavePort>>& Xml_ns0_enclaveProcess_allOf::getPorts()
{
    return m_Ports;
}

void Xml_ns0_enclaveProcess_allOf::setPorts(const std::vector<std::shared_ptr<Xml_ns0_enclavePort>>& value)
{
    m_Ports = value;
    m_PortsIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::portsIsSet() const
{
    return m_PortsIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetPorts()
{
    m_PortsIsSet = false;
}
...
utility::string_t Xml_ns0_enclaveProcess_allOf::getPublicIdent() const
{
    return m_PublicIdent;
}

void Xml_ns0_enclaveProcess_allOf::setPublicIdent(const utility::string_t& value)
{
    m_PublicIdent = value;
    m_PublicIdentIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::publicIdentIsSet() const
{
    return m_PublicIdentIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetPublicIdent()
{
    m_PublicIdentIsSet = false;
}
...
utility::string_t Xml_ns0_enclaveProcess_allOf::getWireguardServer() const
{
    return m_WireguardServer;
}

void Xml_ns0_enclaveProcess_allOf::setWireguardServer(const utility::string_t& value)
{
    m_WireguardServer = value;
    m_WireguardServerIsSet = true;
}

bool Xml_ns0_enclaveProcess_allOf::wireguardServerIsSet() const
{
    return m_WireguardServerIsSet;
}

void Xml_ns0_enclaveProcess_allOf::unsetWireguardServer()
{
    m_WireguardServerIsSet = false;
}
}
