...
/*
 * Json_KubernetesEnclave.h
 *
 * 
 */

#ifndef COM_MADANA_APICLIENT_MODEL_Json_KubernetesEnclave_H_
#define COM_MADANA_APICLIENT_MODEL_Json_KubernetesEnclave_H_
...
/// 
/// </summary>
class  Json_KubernetesEnclave
    : public ModelBase
{
public:
    Json_KubernetesEnclave();
    virtual ~Json_KubernetesEnclave();
    ...
    /////////////////////////////////////////////
    /// Json_KubernetesEnclave members
    ...
    /// 
    /// </summary>
    std::shared_ptr<Json_KubernetesEnclave> getKubernetesEnclave() const;
    bool kubernetesEnclaveIsSet() const;
    void unsetKubernetesEnclave();

    void setKubernetesEnclave(const std::shared_ptr<Json_KubernetesEnclave>& value);
...
protected:
    ...
    std::shared_ptr<Json_KubernetesEnclave> m_KubernetesEnclave;
...
#endif /* COM_MADANA_APICLIENT_MODEL_Json_KubernetesEnclave_H_ */
