...
#ifndef   COM_MADANA_CLIENT_API_RequestServiceApi_H_
#define   COM_MADANA_CLIENT_API_RequestServiceApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<Json_Analysis>> addData(
    ...
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="body"> (optional)</param>
    pplx::task<std::shared_ptr<Json_Analysis>> cancelProcessing(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization,
        boost::optional<std::shared_ptr<Json_SignedData>> body
    ) const;
    ...
    /// <param name="uuid"></param>
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Json_SignedData>> getData(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization
    ) const;
    /// <summary>
    ...
    /// <param name="uuid"></param>
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Json_Analysis>> getRequest(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization
    ) const;
    /// <summary>
    ...
    /// <param name="uuid"></param>
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Json_AnalysisResult>> getResult(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization
    ) const;
    /// <summary>
    ...
    /// <param name="uuid"></param>
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Json_Analysis>> giveConsent(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization
    ) const;
    /// <summary>
    ...
    /// <param name="authorization">Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="body"> (optional)</param>
    pplx::task<std::shared_ptr<Json_Analysis>> setResult(
        utility::string_t uuid,
        boost::optional<utility::string_t> authorization,
        boost::optional<std::shared_ptr<Json_SignedData>> body
    ) const;
...
#endif /*   COM_MADANA_CLIENT_API_RequestServiceApi_H_ */
