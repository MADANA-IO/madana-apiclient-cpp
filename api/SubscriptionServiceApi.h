...
public:
    ...
    pplx::task<std::shared_ptr<HttpContent>> getCheckoutSession(
        utility::string_t productname
    ) const;
    /// <summary>
    /// 
    /// </summary>
    ...
    /// <param name="productname"></param>
    pplx::task<std::shared_ptr<HttpContent>> getCheckoutSession2(
        utility::string_t newplan,
        utility::string_t productname
    ) const;
